...
def test_informacao_internet_pontuacao(classificator):
	...
	assert classificator.informacao_internet_pontuacao("Possuir informações em site e aplicativo atualizados") == 3
	assert classificator.informacao_internet_pontuacao("Possuir informações em site parcialmente atualizado") == 2
	assert classificator.informacao_internet_pontuacao("Possuir informação em site desatualizado") == 1
...
def test_classificar_linhas(classificator):
	...
	assert classificacao.columns.tolist() == ["id_linha", "I1", "I2", "I3", "I4", "I5", "I6", "I7", "I8", "I9", "I10"]
