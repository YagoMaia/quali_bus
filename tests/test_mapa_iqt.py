...
import pytest
from quali_bus.map_tools import MapaIQT
from shapely.geometry import Polygon


@pytest.fixture
def dados_mapa():
	dados = {"Nome_Polo": ["Maracanã"]}
	...
	geometrias = [
		Polygon([
			(-43.84614005469888, -16.750643375323758),
			(-43.84614005469888, -16.750624339635692),
			(-43.845868808488945, -16.750791298594944),
			(-43.84535912270718, -16.750956922802004),
			(-43.84486732094962, -16.75119542524391),
			(-43.842556716816546, -16.751722334665942),
		])
	]
