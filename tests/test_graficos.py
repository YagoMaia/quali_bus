...
def sample_dataframe():
	...
	data = {
		...
		"sentido": [0, 0, 0, 0, 1],
		"id_linha": [4601, 4601, 4601, 4601, 4601],
...
def graficos_instance(sample_dataframe):
	...
	# sample_dataframe['duracao_minutos'] = (pd.to_datetime(sample_dataframe['horario_fim_jornada']) -
	#                                         pd.to_datetime(sample_dataframe['horario_inicio_jornada'])).dt.total_seconds() / 60
